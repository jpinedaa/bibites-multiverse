...
Bibites Multiverse `0.2.3` is public. The first announced service period runs from
...
| Item | Public state |
|---|---|
| Release | [`v0.2.3`](https://github.com/jpinedaa/bibites-multiverse/releases/tag/v0.2.3) |
...
Release `0.2.3` adds the single-file Windows setup and normal application shortcuts.
