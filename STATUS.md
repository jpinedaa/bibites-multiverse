...
Bibites Multiverse `0.2.5` is public. The first announced service period runs from
...
| Item | Public state |
|---|---|
| Release | [`v0.2.5`](https://github.com/jpinedaa/bibites-multiverse/releases/tag/v0.2.5) |
