...
| `M4-Slot6` | The Windows world on the laptop | Requires a save copy from the laptop |

The live host is EC2 instance `i-0a6ee98a24f27bfae`. Its retained data volume is
`vol-0d51c430a70521630`. On 2026-08-15 UTC, all five imported worlds passed the strict readiness
test and a controlled reboot. The test requires an active game, an active mod, a relay grant,
and an applied time scale of `100` for every world.
