...
[![Installer status: 0.3.5 released](https://img.shields.io/badge/installer-0.3.5%20released-4ec9a0)](https://github.com/jpinedaa/bibites-multiverse/releases/tag/v0.3.5)
...
> [!IMPORTANT]
> **Bibites Multiverse `0.3.5` is public.** The Windows download is one setup executable with an
...
> them from the
> [release page](https://github.com/jpinedaa/bibites-multiverse/releases/tag/v0.3.5), and check the
...
1. Download the recommended file for your platform. Compare it with the published
   [`SHA256SUMS`](https://github.com/jpinedaa/bibites-multiverse/releases/download/v0.3.5/SHA256SUMS)
   file.
...
|---|---|---|---|
| Windows | [`bibites-multiverse-0.3.5-windows-x64-setup.exe`](https://github.com/jpinedaa/bibites-multiverse/releases/download/v0.3.5/bibites-multiverse-0.3.5-windows-x64-setup.exe) | Double-click the one downloaded file | Opens the game and launcher after install by default. Later use the **Bibites Multiverse** icon |
| Linux | [`bibites-multiverse-0.3.5-linux-x64-complete.zip`](https://github.com/jpinedaa/bibites-multiverse/releases/download/v0.3.5/bibites-multiverse-0.3.5-linux-x64-complete.zip) | `./install-bibites-multiverse.sh` | `./start-multiverse.sh` |
