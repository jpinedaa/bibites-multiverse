...
[![Installer status: 0.3.10 released](https://img.shields.io/badge/installer-0.3.10%20released-4ec9a0)](https://github.com/jpinedaa/bibites-multiverse/releases/tag/v0.3.10)
...
> [!IMPORTANT]
> **Bibites Multiverse `0.3.10` is public.** The Windows download is one setup executable with an
...
> them from the
> [release page](https://github.com/jpinedaa/bibites-multiverse/releases/tag/v0.3.10), and check the
> SHA-256 before you run or extract a download.
> This release also gives a queue-refused migration bounded, crash-safe progress to another
> compatible world without clearing any identity, save, or journal.
...
1. Download the recommended file for your platform. Compare it with the published
   [`SHA256SUMS`](https://github.com/jpinedaa/bibites-multiverse/releases/download/v0.3.10/SHA256SUMS)
   file.
...
|---|---|---|---|
| Windows | [`bibites-multiverse-0.3.10-windows-x64-setup.exe`](https://github.com/jpinedaa/bibites-multiverse/releases/download/v0.3.10/bibites-multiverse-0.3.10-windows-x64-setup.exe) | Double-click the one downloaded file | Opens the game and launcher after install by default. Later use the **Bibites Multiverse** icon |
| Linux | [`bibites-multiverse-0.3.10-linux-x64-complete.zip`](https://github.com/jpinedaa/bibites-multiverse/releases/download/v0.3.10/bibites-multiverse-0.3.10-linux-x64-complete.zip) | `./install-bibites-multiverse.sh` | `./start-multiverse.sh` |
...
- [Population-aware inbound admission and rollout](docs/population-admission.md)
