...
**Opened 2026-08-09. Full plan: `m5_considerations.md`** — PROPOSED, and nothing in it is
ratified: it recommends nine owner decisions and cannot make any of them.
...
publishes: `contract-a/2.3` (§16 species identity, §17 the census, §18 two-way lanes — which
