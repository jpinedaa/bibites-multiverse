...
**19 MB/h** of ledger and 0.7 MB/h of metrics — about **57 GB/month**, or four months on
the rig's 251 GB volume. Somebody has to decide what the archive is for before that runs
out; every other file in this system is now bounded (see `dev_environment.md`, *The disk
budget*).
